...
bool ImuPose::imu_init(RealSense &rs_t)
{
...
void ImuPose::imu_pose_calculate(FusionVector gyroscope, FusionVector accelerometer)
{
...
rs2_vector ImuPose::return_euler(void)
{
    rs2_vector a;
...
rs2_vector ImuPose::return_earth(void)
{
    rs2_vector a;
    a.x = earth.axis.x;
    a.y = earth.axis.y;
